...
- [ ] Create `summary.txt` with a 3-paragraph summary of Runtime V2 (based on reading architecture doc)
...
- [ ] Read `extensions/taskplane/agent-host.ts` and list all emitEvent() event types; write to `events.txt`
