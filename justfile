...
orch:
    pi -e extensions/task-orchestrator.ts -e extensions/task-runner.ts -e extensions/theme-cycler.ts

# Task Runner only: /task for single task execution (no orchestration)
task:
    pi -e extensions/task-runner.ts -e extensions/theme-cycler.ts
...
# 15. Task Runner: autonomous task execution with live dashboard
ext-task-runner:
    pi -e extensions/task-runner.ts -e extensions/theme-cycler.ts
